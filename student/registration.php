...
<!--
 ...
 <section>
   <div class="reg_img">
    ...
    <div class="box2">
        <h1 style="text-align: center; font-size: 35px;font-family: lucida console;"> &nbsp &nbsp &nbsp
    ...
    if($count==0)    
    {mysql_query($db,"insert into `student`values('$_POST[first]', '$_POST[last]', '$_POST[username]', '$_POST[password]', '$_POST[roll]', '$_POST[email]', '$_POST[contact]');");
    ?>
